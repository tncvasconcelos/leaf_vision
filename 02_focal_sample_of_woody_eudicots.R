...
weights <- readRDS("intermediate_datasets/weights.rds")

prelim_taxa_sample <- sample(names(weights), size = 1000, replace = FALSE, prob = weights)
write.csv(prelim_taxa_sample, "prelim_taxa_sample.csv")
