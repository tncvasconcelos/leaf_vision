...
write.csv(dat, file = "data/la_dat_b.csv", row.names = FALSE)
...
saveRDS(full_model, file = "models/full_model_08b.rds")
write.csv(coef_summary, file = "tables/model_coefficients_08b.csv", row.names = TRUE)
...
saveRDS(model_set, file = "models/model_set_08b.rds")
model_set <- readRDS(file = "models/model_set_08b.rds")
...
writeLines(model_summary_output, "tables/model_summary_output_08b.csv")

coef_summary <- summary(avg_model)$coefficients
write.csv(avg_model$msTable, file = "tables/model_fits_08b.csv", row.names = TRUE)
write.csv(coef_summary, file = "tables/modelavg_coefficients_08b.csv", row.names = TRUE)
